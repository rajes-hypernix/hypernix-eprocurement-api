...
**Target type list (the operator's exact set):** Text, Long Text, Image, Integer Number, List,
Decimal Number, Currency, Percent, Checkbox, Date, Date/Time, Document (attachments), Hyperlink
(with a label), Email Address, Telephone Number.
