...
builder.Services.AddMediator(o =>
{
    ...
    o.Assemblies = [
        ...
        typeof(FSH.Modules.Platform.Contracts.PlatformContractsMarker),
        typeof(FSH.Modules.Platform.PlatformModule),
...
var moduleAssemblies = new Assembly[]
{
    ...
    typeof(FSH.Modules.Platform.PlatformModule).Assembly,
    typeof(SuppliersModule).Assembly,
    typeof(SourcingModule).Assembly,
    typeof(FSH.Modules.Procurement.ProcurementModule).Assembly,
