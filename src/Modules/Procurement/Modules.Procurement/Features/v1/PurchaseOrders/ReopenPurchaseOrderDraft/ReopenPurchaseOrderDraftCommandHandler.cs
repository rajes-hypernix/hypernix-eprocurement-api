...
public sealed class ReopenPurchaseOrderDraftCommandHandler(ProcurementDbContext dbContext)
    : ICommandHandler<ReopenPurchaseOrderDraftCommand, PurchaseOrderDto>
{
    public async ValueTask<PurchaseOrderDto> Handle(ReopenPurchaseOrderDraftCommand command, CancellationToken cancellationToken)
    {
